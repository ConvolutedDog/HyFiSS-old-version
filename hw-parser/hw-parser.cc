...
void hw_config::init(const std::string config_file) {
  ...
  while (inputFile.good()) {
    ...
    if (commentStart != line.npos) continue; // skip comments
    commentStart = line.find_first_of("-");
    if (commentStart == line.npos) continue; // skip blanks
  ...
  /* decode the entries in configs_str */
...
int hw_parser_test() {
  ...
  std::cout << "stack_size_limit: " << hw_cfg.get_stack_size_limit() << std::endl;
  std::cout << "heap_size_limit: " << hw_cfg.get_heap_size_limit() << std::endl;
  std::cout << "kernel_launch_latency: " << hw_cfg.get_kernel_launch_latency() << std::endl;
  std::cout << "thread_block_launch_latency: " << hw_cfg.get_thread_block_launch_latency() << std::endl;
  std::cout << "max_concurent_kernel: " << hw_cfg.get_max_concurent_kernel() << std::endl;
  std::cout << "num_clusters: " << hw_cfg.get_num_clusters() << std::endl;
  std::cout << "num_sms_per_cluster: " << hw_cfg.get_num_sms_per_cluster() << std::endl;
  std::cout << "num_memory_controllers: " << hw_cfg.get_num_memory_controllers() << std::endl;
  std::cout << "num_sub_partition_per_memory_channel: " << hw_cfg.get_num_sub_partition_per_memory_channel() << std::endl;
  ...
  std::cout << "max_registers_per_sm: " << hw_cfg.get_max_registers_per_sm() << std::endl;
  std::cout << "max_registers_per_cta: " << hw_cfg.get_max_registers_per_cta() << std::endl;
  std::cout << "max_threads_per_sm: " << hw_cfg.get_max_threads_per_sm() << std::endl;
  std::cout << "warp_size: " << hw_cfg.get_warp_size() << std::endl;
  std::cout << "max_ctas_per_sm: " << hw_cfg.get_max_ctas_per_sm() << std::endl;
  std::cout << "ID_OC_SP_pipeline_width: " << hw_cfg.get_ID_OC_SP_pipeline_width() << std::endl;
  std::cout << "ID_OC_DP_pipeline_width: " << hw_cfg.get_ID_OC_DP_pipeline_width() << std::endl;
  std::cout << "ID_OC_INT_pipeline_width: " << hw_cfg.get_ID_OC_INT_pipeline_width() << std::endl;
  std::cout << "ID_OC_SFU_pipeline_width: " << hw_cfg.get_ID_OC_SFU_pipeline_width() << std::endl;
  std::cout << "ID_OC_MEM_pipeline_width: " << hw_cfg.get_ID_OC_MEM_pipeline_width() << std::endl;
  std::cout << "OC_EX_SP_pipeline_width: " << hw_cfg.get_OC_EX_SP_pipeline_width() << std::endl;
  std::cout << "OC_EX_DP_pipeline_width: " << hw_cfg.get_OC_EX_DP_pipeline_width() << std::endl;
  std::cout << "OC_EX_INT_pipeline_width: " << hw_cfg.get_OC_EX_INT_pipeline_width() << std::endl;
  std::cout << "OC_EX_SFU_pipeline_width: " << hw_cfg.get_OC_EX_SFU_pipeline_width() << std::endl;
  std::cout << "OC_EX_MEM_pipeline_width: " << hw_cfg.get_OC_EX_MEM_pipeline_width() << std::endl;
  std::cout << "EX_WB_pipeline_width: " << hw_cfg.get_EX_WB_pipeline_width() << std::endl;
  std::cout << "ID_OC_TENSOR_CORE_pipeline_width: " << hw_cfg.get_ID_OC_TENSOR_CORE_pipeline_width() << std::endl;
  std::cout << "OC_EX_TENSOR_CORE_pipeline_width: " << hw_cfg.get_OC_EX_TENSOR_CORE_pipeline_width() << std::endl;
  ...
  std::cout << "num_tensor_core_units: " << hw_cfg.get_num_tensor_core_units() << std::endl;
  // INT: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4, SHFL = 5,
  std::cout << "opcode_latency_int_ADD: " << hw_cfg.get_opcode_latency_int(ADD) << std::endl;
  std::cout << "opcode_latency_int_MAX: " << hw_cfg.get_opcode_latency_int(MAX) << std::endl;
  std::cout << "opcode_latency_int_MUL: " << hw_cfg.get_opcode_latency_int(MUL) << std::endl;
  std::cout << "opcode_latency_int_MAD: " << hw_cfg.get_opcode_latency_int(MAD) << std::endl;
  std::cout << "opcode_latency_int_DIV: " << hw_cfg.get_opcode_latency_int(DIV) << std::endl;
  std::cout << "opcode_latency_int_SHFL: " << hw_cfg.get_opcode_latency_int(SHFL) << std::endl;
  // FP: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4
  std::cout << "opcode_latency_fp_ADD: " << hw_cfg.get_opcode_latency_fp(ADD) << std::endl;
  std::cout << "opcode_latency_fp_MAX: " << hw_cfg.get_opcode_latency_fp(MAX) << std::endl;
  std::cout << "opcode_latency_fp_MUL: " << hw_cfg.get_opcode_latency_fp(MUL) << std::endl;
  std::cout << "opcode_latency_fp_MAD: " << hw_cfg.get_opcode_latency_fp(MAD) << std::endl;
  std::cout << "opcode_latency_fp_DIV: " << hw_cfg.get_opcode_latency_fp(DIV) << std::endl;
  // DP: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4
  std::cout << "opcode_latency_dp_ADD: " << hw_cfg.get_opcode_latency_dp(ADD) << std::endl;
  std::cout << "opcode_latency_dp_MAX: " << hw_cfg.get_opcode_latency_dp(MAX) << std::endl;
  std::cout << "opcode_latency_dp_MUL: " << hw_cfg.get_opcode_latency_dp(MUL) << std::endl;
  std::cout << "opcode_latency_dp_MAD: " << hw_cfg.get_opcode_latency_dp(MAD) << std::endl;
  std::cout << "opcode_latency_dp_DIV: " << hw_cfg.get_opcode_latency_dp(DIV) << std::endl;
  // SFU
  std::cout << "opcode_latency_sfu: " << hw_cfg.get_opcode_latency_sfu() << std::endl;
  // TENSOR_CORE
  std::cout << "opcode_latency_tensor_core: " << hw_cfg.get_opcode_latency_tensor_core() << std::endl;
  // INT: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4, SHFL = 5,
  std::cout << "opcode_initiation_interval_int_ADD: " << hw_cfg.get_opcode_initiation_interval_int(ADD) << std::endl;
  std::cout << "opcode_initiation_interval_int_MAX: " << hw_cfg.get_opcode_initiation_interval_int(MAX) << std::endl;
  std::cout << "opcode_initiation_interval_int_MUL: " << hw_cfg.get_opcode_initiation_interval_int(MUL) << std::endl;
  std::cout << "opcode_initiation_interval_int_MAD: " << hw_cfg.get_opcode_initiation_interval_int(MAD) << std::endl;
  std::cout << "opcode_initiation_interval_int_DIV: " << hw_cfg.get_opcode_initiation_interval_int(DIV) << std::endl;
  std::cout << "opcode_initiation_interval_int_SHFL: " << hw_cfg.get_opcode_initiation_interval_int(SHFL) << std::endl;
  // FP: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4,
  std::cout << "opcode_initiation_interval_fp_ADD: " << hw_cfg.get_opcode_initiation_interval_fp(ADD) << std::endl;
  std::cout << "opcode_initiation_interval_fp_MAX: " << hw_cfg.get_opcode_initiation_interval_fp(MAX) << std::endl;
  std::cout << "opcode_initiation_interval_fp_MUL: " << hw_cfg.get_opcode_initiation_interval_fp(MUL) << std::endl;
  std::cout << "opcode_initiation_interval_fp_MAD: " << hw_cfg.get_opcode_initiation_interval_fp(MAD) << std::endl;
  std::cout << "opcode_initiation_interval_fp_DIV: " << hw_cfg.get_opcode_initiation_interval_fp(DIV) << std::endl;
  // DP: ADD = 0, MAX = 1, MUL = 2, MAD = 3, DIV = 4,
  std::cout << "opcode_initiation_interval_dp_ADD: " << hw_cfg.get_opcode_initiation_interval_dp(ADD) << std::endl;
  std::cout << "opcode_initiation_interval_dp_MAX: " << hw_cfg.get_opcode_initiation_interval_dp(MAX) << std::endl;
  std::cout << "opcode_initiation_interval_dp_MUL: " << hw_cfg.get_opcode_initiation_interval_dp(MUL) << std::endl;
  std::cout << "opcode_initiation_interval_dp_MAD: " << hw_cfg.get_opcode_initiation_interval_dp(MAD) << std::endl;
  std::cout << "opcode_initiation_interval_dp_DIV: " << hw_cfg.get_opcode_initiation_interval_dp(DIV) << std::endl;
  // SFU
  std::cout << "opcode_initiation_interval_sfu: " << hw_cfg.get_opcode_initiation_interval_sfu() << std::endl;
  // TENSOR_CORE
  std::cout << "opcode_initiation_interval_tensor_core: " << hw_cfg.get_opcode_initiation_interval_tensor_core() << std::endl;
  std::cout << "sub_core_model: " << hw_cfg.get_sub_core_model() << std::endl;
  std::cout << "operand_collector_num_units_gen: " << hw_cfg.get_operand_collector_num_units_gen() << std::endl;
  std::cout << "operand_collector_num_in_ports_gen: " << hw_cfg.get_operand_collector_num_in_ports_gen() << std::endl;
  std::cout << "operand_collector_num_out_ports_gen: " << hw_cfg.get_operand_collector_num_out_ports_gen() << std::endl;
  std::cout << "num_reg_banks: " << hw_cfg.get_num_reg_banks() << std::endl;
  std::cout << "reg_file_port_throughput: " << hw_cfg.get_reg_file_port_throughput() << std::endl;
  std::cout << "shmem_num_banks: " << hw_cfg.get_shmem_num_banks() << std::endl;
  std::cout << "shmem_limited_broadcast: " << hw_cfg.get_shmem_limited_broadcast() << std::endl;
  std::cout << "shmem_warp_parts: " << hw_cfg.get_shmem_warp_parts() << std::endl;
  std::cout << "coalesce_arch: " << hw_cfg.get_coalesce_arch() << std::endl;
  std::cout << "num_sched_per_sm: " << hw_cfg.get_num_sched_per_sm() << std::endl;
  std::cout << "max_insn_issue_per_warp: " << hw_cfg.get_max_insn_issue_per_warp() << std::endl;
  std::cout << "dual_issue_diff_exec_units: " << hw_cfg.get_dual_issue_diff_exec_units() << std::endl;
  std::cout << "unified_l1d_size: " << hw_cfg.get_unified_l1d_size() << std::endl;
  std::cout << "l1d_cache_banks: " << hw_cfg.get_l1d_cache_banks() << std::endl;
  std::cout << "l1d_cache_sets: " << hw_cfg.get_l1d_cache_sets() << std::endl;
  std::cout << "l1d_cache_block_size: " << hw_cfg.get_l1d_cache_block_size() << std::endl;
  std::cout << "l1d_cache_associative: " << hw_cfg.get_l1d_cache_associative() << std::endl;
  std::cout << "l1d_latency: " << hw_cfg.get_l1d_latency() << std::endl;
  std::cout << "shmem_size_per_sm: " << hw_cfg.get_shmem_size_per_sm() << std::endl;
  std::cout << "shmem_size_per_cta: " << hw_cfg.get_shmem_size_per_cta() << std::endl;
  std::cout << "shmem_latency: " << hw_cfg.get_shmem_latency() << std::endl;
  std::cout << "l2d_size_per_sub_partition: " << hw_cfg.get_l2d_size_per_sub_partition() << std::endl;
  std::cout << "l2d_cache_sets: " << hw_cfg.get_l2d_cache_sets() << std::endl;
  std::cout << "l2d_cache_block_size: " << hw_cfg.get_l2d_cache_block_size() << std::endl;
  std::cout << "l2d_cache_associative: " << hw_cfg.get_l2d_cache_associative() << std::endl;
  std::cout << "dram_partition_queues_icnt_to_l2: " << hw_cfg.get_dram_partition_queues_icnt_to_l2() << std::endl;
  std::cout << "dram_partition_queues_l2_to_dram: " << hw_cfg.get_dram_partition_queues_l2_to_dram() << std::endl;
  std::cout << "dram_partition_queues_dram_to_l2: " << hw_cfg.get_dram_partition_queues_dram_to_l2() << std::endl;
  std::cout << "dram_partition_queues_l2_to_icnt: " << hw_cfg.get_dram_partition_queues_l2_to_icnt() << std::endl;
  std::cout << "num_pkts_cluster_ejection_buffer: " << hw_cfg.get_num_pkts_cluster_ejection_buffer() << std::endl;
  std::cout << "icnt_in_buffer_limit: " << hw_cfg.get_icnt_in_buffer_limit() << std::endl;
  std::cout << "icnt_out_buffer_limit: " << hw_cfg.get_icnt_out_buffer_limit() << std::endl;
