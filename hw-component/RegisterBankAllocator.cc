...
RegisterBankAllocator::RegisterBankAllocator(const unsigned smid, const unsigned num_banks, 
...
unsigned RegisterBankAllocator::register_bank(const unsigned regnum, const unsigned wid, const unsigned sched_id) const {
...
Register_Bank_State RegisterBankAllocator::getBankState(const unsigned bank_id) const {
  return m_bank_state[bank_id];
}

Register_Bank_State RegisterBankAllocator::getBankState(const unsigned regnum, const unsigned wid, const unsigned sched_id) const {
  unsigned bank_id = register_bank(regnum, wid, sched_id);
  return m_bank_state[bank_id];
}

void RegisterBankAllocator::setBankState(const unsigned bank_id, const Register_Bank_State state) {
