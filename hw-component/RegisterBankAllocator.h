...
class RegisterBankAllocator {
 public:
  ...
  unsigned register_bank(const unsigned regnum, const unsigned wid, const unsigned sched_id) const;

  Register_Bank_State getBankState(const unsigned bank_id) const;

  Register_Bank_State getBankState(const unsigned regnum, const unsigned wid, const unsigned sched_id) const;

  void setBankState(const unsigned bank_id, const Register_Bank_State state);
  void setBankState(const unsigned regnum, const unsigned wid, const unsigned sched_id, const Register_Bank_State state);

  void releaseBankState(const unsigned regnum, const unsigned wid, const unsigned sched_id);
